...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_A_MAX_TRAVEL 600.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_B_MAX_TRAVEL 600.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_C_MAX_TRAVEL 600.0 // mm NOTE: Must be a positive value.
